 ...
 * Contiene información detallada sobre el producto, como su identificador,
 * nombre, descripción, precio y stock disponible.
 *
 * @version 1.0
 * @since 2025-05-17
 * @author TuNombre (o el nombre del equipo)
 */
